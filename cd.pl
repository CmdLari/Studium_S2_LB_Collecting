...
% KNR ist Schluessel.
% null-Werte sind an allen Positionen möglich
% Tupel 11 - 51.
...
komponist(null, 'error', 'exception', 1342, 1388).
komponist(null, 'error', 'exception', null, null).
...
komponist(52, null, 'Boulez', 4288, 8842).
...
stueck(null, 88, 'error', 'exception', 'Op.4/2').
